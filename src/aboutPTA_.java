...
public class aboutPTA_ implements PlugIn {
	...
	public void run(String arg0) {
		...
		String message = "Particle Track and Analysis (PTA) Version 1.1\n" +
				...
				"This software incorporates JFreeChart, (C)opyright 2000-2009\n" +
				"by Object Renery Limited and Contributors.";
		MessageDialog md = new MessageDialog(null,title,message);
	}
